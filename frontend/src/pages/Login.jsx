...
function Login() {
    ...
    return (
        <div className="fixed inset-0 z-50 flex flex-col md:flex-row min-h-screen bg-white">
            ...
            {/* Left Panel - Branding (Identical to Signup) */}
            <div className="w-full md:w-5/12 bg-gradient-to-br from-[#4f18a3] to-[#8b31ff] relative overflow-hidden p-12 text-white flex flex-col justify-center">
                ...
                <div className="relative z-10">
                    ...
                    <h1 className="text-5xl font-bold leading-tight mb-6">
                        Welcome back<br />to your Circle.
                    </h1>

                    <p className="text-lg text-purple-100 max-w-md">
                        Pick up where you left off. Connect, share, and grow with your community.
                    </p>
                </div>
            </div>
            ...
            <div className="w-full md:w-7/12 overflow-y-auto bg-white p-8 md:p-12 lg:p-16 flex flex-col justify-center">
                <div className="max-w-md mx-auto w-full">
                    ...
                    <form onSubmit={handleSubmit} className="space-y-6">
                        ...
                        <div>
                            <div className="flex justify-between items-center mb-2">
                                ...
                                <Link to="/forgot-password" className="text-xs text-[#5b1da3] hover:text-[#4a1586] font-bold transition-colors">Forgot Password?</Link>
                            </div>
                    ...
                    <div className="mt-8">
                        <button type="button" className="w-full flex items-center justify-center px-4 py-3 border border-gray-300 rounded-xl hover:bg-gray-50 transition-all duration-200 shadow-sm hover:shadow-md group">
                            ...
                            <span className="font-semibold text-gray-700 group-hover:text-gray-900">Login in with Google</span>
                        </button>
                    </div>

                    <p className="mt-8 text-center text-gray-600">
                        Don't have an account?{' '}
                        <Link to="/signup" className="text-[#5b1da3] font-bold hover:underline">
                            Sign Up
                        </Link>
                    </p>
                </div>
