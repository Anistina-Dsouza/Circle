            ...
            <div className="max-w-[1000px] w-full mx-auto px-6 py-10">
                ...
                <div className="flex items-center gap-4 mb-10">
                    ...
                    <div>
                        ...
                        <p className="text-gray-400 font-medium">Configure privacy, branding, and permissions for your circle.</p>
                    </div>
                </div>
                ...
                <div className="bg-[#1A0B3D]/50 border border-white/5 rounded-3xl p-12 flex flex-col items-center justify-center text-center">
                    ...
                    <p className="text-gray-500 max-w-sm">We're designing a comprehensive settings experience to give you full control over your community.</p>
                </div>
            </div>
        </div>
    );
